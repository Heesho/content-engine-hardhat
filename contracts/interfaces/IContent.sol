...
interface IContent {
    ...
    function id_EpochId(uint256 tokenId) external view returns (uint256);
    function id_InitPrice(uint256 tokenId) external view returns (uint256);
    function id_StartTime(uint256 tokenId) external view returns (uint256);
